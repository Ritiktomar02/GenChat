...
export const sendVerificationEmail = async (email, verificationToken) => {
  try {
    await transporter.sendMail({
      from: `"GenChat" <${process.env.GMAIL_USER}>`,
      to: email,
      subject: "Your verification code for GenChat",
...
export const sendWelcomeEmail = async (email, username) => {
  try {
    await transporter.sendMail({
      from: `"GenChat" <${process.env.GMAIL_USER}>`,
      to: email,
      subject: "Welcome to GenChat 🎉",
      text: `Hi ${username}, your email has been verified successfully. Welcome to GenChat!`,
...
export const sendPasswordResetEmail = async (email, resetURL) => {
  try {
    await transporter.sendMail({
      from: `"GenChat" <${process.env.GMAIL_USER}>`,
      to: email,
      subject: "Reset your GenChat password",
